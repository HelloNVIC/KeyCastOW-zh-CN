...
<p align="center">
  <img src="img/image.png" alt="运行效果" width="500">
</p>
...
| 🔁 重复按键控制 | 可关闭按键自动重复捕获，用于缓解 K380 等蓝牙键盘连接不稳定导致的重复按键问题 |
...
2. 双击运行程序
3. 在系统托盘中打开设置
4. 调整按键标签样式、显示位置、品牌标识、开机自动启动等选项
5. 开始录屏、直播或演示
...
可在设置窗口勾选“开机自动启动”，程序会写入当前用户的 Windows 启动项；取消勾选后会自动移除启动项。

### 6. 抑制蓝牙键盘异常重复输入

部分蓝牙键盘（如 Logitech K380）在连接不稳定时，可能出现一次按键被系统重复捕获的问题。可在设置中关闭“按住视为重复”，用于缓解这类异常重复按键。

> 注意：关闭此功能会影响整个系统的按键捕获行为，可能影响方向键等需要长按连续触发的按键。

<p align="center">
  <img src="img/image2.png" alt="K380配置" width="500">
</p>
